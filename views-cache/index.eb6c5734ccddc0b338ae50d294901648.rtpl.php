      ...
      <section class="mt-5 wow fadeIn" id="icons">
        <div class="row">
          <div class="col-md-6 col-sm-12">
            ...
            <div class="text-icons">
              ...
              <p>
                Precisa de ajuda? Navegue pela documentação e aprenda mais sobre
                o MedView usando a documentação neste site.
              </p>
            </div>
          </div>
          <div class="col-md-6 col-sm-12">
            <div class="centralizar">
              <a class="js-scroll-trigger" href="#ramais"
                ><img
                  src="/res/site/img/svg/telephone.svg"
                  class="img-fluid img-responsive"
              /></a>
            </div>
            <div class="text-icons">
        ...
        <div class="row mt-5">
          <div class="col-md-6 col-sm-12 mb-2">
            <div class="centralizar">
              <a
                href="//ecm:8080/share/page/site/institucional/documentlibrary"
                target="_blank"
                ><img
                  src="/res/site/img/svg/file.svg"
                  class="img-fluid img-responsive"
              /></a>
            </div>
            <div class="text-icons">
              ...
              <div class="btn-group">
                ...
                <div class="dropdown-menu">
                  <a class="dropdown-item"
                    >Usuario: <strong>Visitante</strong></a
                  >
          ...
          <div class="col-md-6 col-sm-12">
            <div class="centralizar">
              <a href="/notificacao"
                ><img
                  src="/res/site/img/svg/notification.svg"
                  class="img-fluid img-responsive"
              /></a>
            </div>
            <div class="text-icons">
