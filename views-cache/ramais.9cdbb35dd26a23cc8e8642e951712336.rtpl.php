    ...
    <section class="content">
        ...
        <div class="col-12">
            ...
            <div class="box-header">
                <a href="/admin/ramais/create" class="btn btn-success pull-right" style="margin-right: 20px; margin-top: 10px;">Cadastrar Ramal</a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                ...
                <tbody>
                    <?php $counter1=-1;  if( isset($ramais) && ( is_array($ramais) || $ramais instanceof Traversable ) && sizeof($ramais) ) foreach( $ramais as $key1 => $value1 ){ $counter1++; ?>
                    <tr>
                    <td><?php echo htmlspecialchars( $value1["id_agenda"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
                    ...
                    <td>
                        <a href="/admin/ramais/<?php echo htmlspecialchars( $value1["id_agenda"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> Editar</a>
                        <a href="/admin/ramais/<?php echo htmlspecialchars( $value1["id_agenda"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/delete" onclick="return confirm('Deseja realmente excluir este registro?')" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Excluir</a>
                    </td>
                    </tr>
                    <?php } ?>
                </tbody>
