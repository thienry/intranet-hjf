...
<body id="top" class="grey lighten-3">
          ...
          <ul class="navbar-nav mr-auto text-white">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu hove" aria-labelledby="navbarDropdown" style="background: #8d1d2e;">
                ...
                <a class="dropdown-item" href="/convenants-list" >Lista de Convênios</a>
              </div>
            </li>
  ...
  <!--- Main Content -->
  <div class="container">
    <section class="mt-5 pt-5 mb-5 wow fadeIn">
      <div class="tabelaRamal">
        <div class="infoRamal">
          <!-- Main heading -->
          <h1 class="h1 mb-3" style="text-align: center">Lista de Convênios</h1>
        </div>
      </div>
      ...
      <div class="card">
        <div class="card-body">
          <!--Table-->
          <table id="convenant-table" class="table table-hover table-responsive-md table-fixed table-striped">
            <!--Table head-->
            <thead>
              <tr>
                <th><h6>Convênio</h6></th>
                <th><h6>Call Center</h6></th>
                <th><h6>Site</h6></th>
              </tr>
            </thead>
            <!--Table head-->
            <!--Table body-->
            <tbody>
              <?php $counter1=-1;  if( isset($convenant) && ( is_array($convenant) || $convenant instanceof Traversable ) && sizeof($convenant) ) foreach( $convenant as $key1 => $value1 ){ $counter1++; ?>
                <tr>
                  <th><strong><?php echo htmlspecialchars( $value1["name_convenant"], ENT_COMPAT, 'UTF-8', FALSE ); ?></strong></th>
                  <td><strong><?php echo htmlspecialchars( $value1["call_center"], ENT_COMPAT, 'UTF-8', FALSE ); ?></strong></td>
                  <td>
                    <a href="<?php echo htmlspecialchars( $value1["site"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" target="_blank">
                      <strong><?php echo htmlspecialchars( $value1["site"], ENT_COMPAT, 'UTF-8', FALSE ); ?></strong>
                    </a>
                  </td>
                </tr>
              <?php } ?>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      $('#convenant-table').DataTable({
        "language": {
          "lengthMenu": "",
          "zeroRecords": "Convênio não encontrado",
