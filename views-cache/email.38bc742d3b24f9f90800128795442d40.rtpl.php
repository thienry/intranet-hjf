...
<head>
    ...
    <title>Email - Notificações de Eventos</title>
...
<body class="respond" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
                    ...
                    <tr>
                        <td align="center">
                            ...
                            <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" class="container590">
                                <!--
                                <tr>
                                    <td align="center" height="150" style="height:150px;">
                                        <a href="" style="display: block; border-style: none !important; border: 0 !important;"><img width="300" border="0" style="display: block; width: 300px;" src="/res/site/img/jayme-da-fonte-desde.png" alt="" /></a>
                                    </td>
                                </tr>
                                -->
                                <tr>
                                    <td align="center">
                                        <table width="360 " border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"
                                            ...
                                            <tr>
                                                <td align="center" style="font-size: 24px; font-family: 'Roboto', Calibri, sans-serif; line-height: 24px;">
                                                    <a href="/notificacao" target="_blank" style="color: #312c32; text-decoration: none;">Notificacoes de Eventos</a>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                    ...
                    <tr>
                        <td align="center" style="color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;"
                            ...
                            <div style="line-height: 35px">
                                ...
                                Foi realizada uma nova <span style="color: #5caad2;">Notificacao</span>
                            ...
                            <table border="0" width="590" align="center" cellpadding="0" cellspacing="0" class="container590">
                                <tr>
                                    <td align="left" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        ...
                                        <table border="0" align="center" width="180" cellpadding="0" cellspacing="0" bgcolor="ffffff" style="margin-bottom:20px;">
    ...
    <!-- main section -->
    <table border="0" width="100%" cellpadding="0" cellspacing="0" bgcolor="8d1d2e">

        <tr>
            <td align="center" style="background-image: url('/res/site/img/slide-4.jpg'); background-size: cover; background-position: top center; background-repeat: no-repeat;"
                background="/res/site/img/slide-4.jpg">
                                            ...
                                            <tr>
                                                <td align="center" style="color: #cccccc; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 26px;">
                                                    ...
                                                    <div style="line-height: 26px">
                                                        ...
                                                        Intranet Jayme da Fonte, feito para os funcionarios.
                    ...
                    <tr>
                        <td align="center">
                            <table border="0" align="center" width="250" cellpadding="0" cellspacing="0" style="border:2px solid #ffffff;">
                                ...
                                <tr>
                                    <td align="center" style="color: #ffffff; font-size: 14px; font-family: 'Roboto', Calibri, sans-serif; line-height: 22px; letter-spacing: 2px;">
                                        <!-- main section button -->

                                        <div style="line-height: 22px;">
                                            <a href="//intranet.com.br"  style="color: #fff; text-decoration: none;">Intranet</a>
                                        </div>
                                    </td>
                                </tr>
                                            ...
                                            <tr>
                                                <td align="left" style="color: #888888; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 23px;"
                                                    ...
                                                    <div style="color: #333333; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; font-weight: 600; mso-line-height-rule: exactly; line-height: 23px;">
                                                        ...
                                                        Email us: <br/> <a href="mailto:" style="color: #888888; font-size: 14px; font-family: 'Roboto', Calibri, Sans-serif; font-weight: 400;">cpd@jaymedafonte.com.br</a>
                                ...
                                <tr>
                                    <td align="left" style="color: #aaaaaa; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        <div style="line-height: 24px;">
                                            ...
                                            <span style="color: #000;">Equipe CPD</span>
                                ...
                                <tr>
                                    <td align="center">
                                        <table align="center" border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td align="center">
                                                    <p style="font-size: 14px; font-family: 'Roboto', Calibri, sans-serif; line-height: 24px;color: #333333; text-decoration: none;font-weight:bold;">Design by <strong>Thiago Moura</strong></p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
