        ...
        <div class="row">
          <div class="col-md-10">
            ...
            <div class="jumbotron bg-primary">
                <h1 class="display-4" >Painel Admin do sistema de postagens do hospital Jayme da Fonte</h1>
                <p class="lead" >Esse sistema foi concebido para que os funcionarios responsaveis pela parte de marketing do hospital possa fazer todo o gerenciamento de divulgacao interno do hospital. </p>
                <hr class="my-4">
                <p >Cadastrando postagens para serem expostas na intranet.</p>
                <a class="btn btn-info btn-lg" href="/blog" role="button" >Blog HJF</a>
            </div>
          </div>
          <div class="col-md-2">
            <!-- small box -->
            <div class="small-box bg-success">
                ...
                <a href="/admin/posts" class="small-box-footer">Mais detalhes <i class="fa fa-arrow-circle-right"></i></a>
              </div>
          </div>
        </div>
        <hr class="mb-5">
        ...
        <div class="row"> 
          ...
          <div class="col-lg-3 col-md-4 col-sm-6">
            <div class="card card-primary card-outline" >
              <img class="card-img-top img-fluid" src="<?php echo htmlspecialchars( $value1["desphoto"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" alt="" style="height: 200px;">
              <div class="card-body">
